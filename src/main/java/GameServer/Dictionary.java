    ...
    public Dictionary(String... fileName) {
        ...
        try {
            for (String name : fileNames) {
                ...
                sb.append("src/main/resources/books/"+name);
                //sb.append(name);
                name = sb.toString();
                BufferedReader reader = new BufferedReader(new FileReader(name));
                //BufferedReader reader = new BufferedReader(new FileReader("/Users/md/Desktop/Game_Server/src/main/resources/books/aliceInWonderandupper.txt"));
            ...
            System.out.println("Dictionary: problem with IO");
        }
    }
